...
module.exports = function(urlName) {
  ...
  transform.ticketsToGoals = function (callback, results) {
    ...
    var errorMessage = collectNonSuccessJSendResponses(results);
  ...
  function collectNonSuccessJSendResponses(results) {
    debug('collectNonSuccessJSendResponses: results %j', results);
    ...
    debug('collectNonSuccessJSendResponses: return err: %j, errorMessages: %j', err, errorMessages);
